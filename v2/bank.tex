...
\newcommand{\GoodQuestions}[1]{\marginpar{\textbf{Good Questions} #1}}
...
\begin{problem}
  ...
  \begin{tikzpicture}[x=0.15\textwidth]
    ...
    \draw (.8,0) node [circle,fill,inner sep=1pt,label=above:$x$](e){};
    \draw (3.13,0) node [circle,fill,inner sep=1pt,label=above:$y$](e){};
  \end{tikzpicture}
  \end{image}
  What is the best guess for $xy$?
  \begin{multipleChoice}
...
\begin{problem}
  \recommendation{Vic} When I zoom in on the graph of $f$ near the
